...
class ShowAlert {
  ...
  static void showStyledToast(String msg, BuildContext context,
      {Color backgroundColor = AppColours.secondary}) {
    showToast(msg,
        context: context,
        ...
        textStyle: Styles.of(context)
            .headStyle1
            .copyWith(fontSize: 15, color: AppColours.white));
  }
}
